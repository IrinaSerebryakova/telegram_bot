...
CREATE TABLE notification_task (id SERIAL PRIMARY KEY, chat_id VARCHAR(255), message TEXT, date_time TIMESTAMP);

-- changeset IrinaSerebryakova:2
insert INTO public.notification_task (chat_id, message, date_time) VALUES ('614749807', 'Сделать домашнюю работу', '16.02.2025 12:10');
