...
public class NotificationCommand implements TelegramCommand {
    private final static Logger logger = LoggerFactory.getLogger(NotificationCommand.class);
    ...
    public void matchesAndSave(Matcher matcher, Update update) {
        if (matcher.matches()) {
